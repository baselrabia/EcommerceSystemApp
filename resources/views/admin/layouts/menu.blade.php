        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview {{ active_menu('admin')[0] }}">
            ...
            <ul class="treeview-menu" style="{{ active_menu('admin')[1] }}">
              <li class=""><a href="{{ aurl('admins') }}"><i class="fa fa-users"></i> {{ trans('admin.admin') }}</a></li>
          ...
          <li class="treeview {{ active_menu('cities')[0] }}">
            <a href="#">
              <i class="fa fa-car"></i> <span>{{ trans('admin.cities') }}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-left"></i>
              </span>
            </a>
            <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
              <li class=""><a href="{{ aurl('cities') }}"><i class="fa fa-car"></i> {{ trans('admin.cities') }}</a></li>
          ...
          <li class="treeview {{ active_menu('states')[0] }}">
            <a href="#">
              <i class="fa fa-building"></i> <span>{{ trans('admin.states') }}</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-right pull-left"></i>
              </span>
            </a>
            <ul class="treeview-menu" style="{{ active_menu('states')[1] }}">
              <li class=""><a href="{{ aurl('states') }}"><i class="fa fa-building"></i> {{ trans('admin.states') }}</a></li>
          ...
          <li class="{{ active_menu('settings')[0] }}">
